...
INSTALLED_APPS = [
    ...
    'blog',
    'django_quill',
    'whitenoise.runserver_nostatic', #Heroku Deployment of static files
]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #Heroku Deployment of static files
]
...
#Below are for static file deployment on Heroku
